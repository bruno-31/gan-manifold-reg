...
def random_translate(inputs, scale, is_training, padding_mode='REFLECT', name='random_translate'):
    ...
    with tf.name_scope(name) as scope:
        with tf.control_dependencies([
            ...
            filters = tf.matmul(one_hots(vertical_offsets),
                                ...
                                adjoint_a=True)
            assert_shape(filters, [None, kernel_size, kernel_size])
            ...
            assert_shape(depthwise_filters, [kernel_size, kernel_size, None, 1])
